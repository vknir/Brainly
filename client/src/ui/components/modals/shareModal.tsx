                ...
                <div className="bg-white/50 w-full h-dvh absolute z-10 animate-appear flex justify-center">
                    <div className="w-100 bg-amber-200 h-min p-4 rounded-md mt-6 flex flex-col gap-4">
                        <div className="flex w-full justify-between items-center">
                            <p className="text-lg leading-none">Share your collection as per your choice</p>

                            <div>
                                <Button className="p-0 hover:cursor-pointer" onClick={() => setIsVisible(false)}
                                    variant="none" startIcon={<Close className="size-4" />} />
                            </div>
                        </div>
                        ...
                        <div className="border  rounded-md flex justify-between items-center bg-amber-300">
                            ...
                            <div className="border-l p-2">
                                <Button onClick={() => copy(textToCopy)} variant="none"
                                    className="p-0 hover:cursor-pointer"
                                    startIcon={isCopied ?
                                        <Tick className="size-4 animate-appear" /> :
                                        <Clipboard className="size-4 animate-appear" />}
                                />
                            </div>
